...
#define STRING_VERSION_CONFIG_H __DATE__ "25/05/2016 1206h" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Ryan Peach, reprap.pt)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,291,291}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 1000,1000}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {3000,3000,50,10000,10000}    // X, Y, Z, E0, E1 maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define SERVO_ENDSTOP_ANGLES {{0,0},{0,0},{0,180}} // X,Y,Z Axis Extend and Retract angles
